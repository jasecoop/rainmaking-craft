...
},{"./lib/balancedGallery":1,"./lib/colourThief":2,"./lib/jquery":3,"./scripts/craft-ajax":5,"./scripts/menu":6,"./scripts/pillarbox":7,"./scripts/rain":8,"./scripts/stickyHeader":9}],5:[function(require,module,exports){
module.exports = function () {
...
module.exports = function () {
  ...
  var contentHide = function(type) {
    ...
    $(target).removeClass('pillarbox-active');
    // $('.intro-logo').removeClass('active');
    // $('.intro-logo-active').hide()
    $('#home-intro-hover-text').html(introText);
  ...
  var contentShow = function(type, pos) {
    // positionLogo();
    var target = '.pillarbox-' + type;
    var text = $(target + ' .pbc__text').html();
